...
public class ModelVanillaOars extends EntityModel<Entity> {
    ...
    public ModelVanillaOars() {
        ...
        this.paddles11.addCuboid(-1.0010000467300415F, -3.0F, 8.0F, 1, 6, 7, 0.0F);
        ...
        this.paddles20.addCuboid(-1.0F, 0.0F, -5.0F, 2, 2, 18, 0.0F);
        ...
        this.paddles10.addCuboid(-1.0F, 0.0F, -5.0F, 2, 2, 18, 0.0F);
        ...
        this.paddles21.addCuboid(0.0010000000474974513F, -3.0F, 8.0F, 1, 6, 7, 0.0F);
