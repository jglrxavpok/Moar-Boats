...
public class ModularBoatModel<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition anchors = partdefinition.addOrReplaceChild("anchors", CubeListBuilder.create().texOffs(40, 19).addBox(-18.0F, -30.0F, -1.0F, 2.0F, 7.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(48, 19).addBox(16.0F, -30.0F, -1.0F, 2.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
