...
object BlockWaterborneComparator: RedstoneDiodeBlock(Properties.create(Material.MISCELLANEOUS).notSolid().tickRandomly().hardnessAndResistance(0f).sound(SoundType.WOOD)) {
    init {
