...
object BlockWaterborneComparator: RedstoneDiodeBlock(Properties.create(Material.MISCELLANEOUS).nonOpaque().tickRandomly().hardnessAndResistance(0f).sound(SoundType.WOOD)) {
    init {
