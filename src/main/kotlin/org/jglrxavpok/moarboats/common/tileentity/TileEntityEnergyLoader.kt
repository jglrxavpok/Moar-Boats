...
class TileEntityEnergyLoader(blockPos: BlockPos, blockState: BlockState): TileEntityEnergy(BlockEntities.EnergyLoader.get(), blockPos, blockState), ITickableTileEntity {
