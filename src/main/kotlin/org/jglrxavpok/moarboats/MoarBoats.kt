...
object MoarBoats {
    ...
    fun preInit(event: FMLPreInitializationEvent) {
        ...
        BoatModuleRegistry.registerModule(BlockPlacerModule, Item.getItemFromBlock(MCBlocks.DEADBUSH), { boat, module -> SimpleModuleInventory(3*9, "block_placer", boat, module) })
