...
class WaypointInfoEntry(val parent: GuiWaypointEditor, val slot: WaypointInfo, val slotTops: MutableMap<Int, Int>, val waypoints: List<WaypointInfoEntry>): ExtendedList.AbstractListEntry<WaypointInfoEntry>() {
    ...
    override fun render(entryWidth: Int, entryHeight: Int, mouseX: Int, mouseY: Int, p_render_5_: Int, p_render_6_: Int, p_render_7_: Int, p_194999_5_: Boolean, partialTicks: Float) {
        ...
        list.blit(0, 0, 32, hovered * 32, 32, 32, blitOffset.toFloat()) // top
