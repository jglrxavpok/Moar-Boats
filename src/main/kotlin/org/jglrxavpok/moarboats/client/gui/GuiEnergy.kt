...
class GuiEnergy(isLoading: Boolean, containerID: Int, val te: TileEntityEnergy, val player: Player): AbstractContainerScreen<EnergyContainer>(EnergyContainer(isLoading, containerID, te, player), player.inventory, Component.translatable("inventory.moarboats.energy")) {
