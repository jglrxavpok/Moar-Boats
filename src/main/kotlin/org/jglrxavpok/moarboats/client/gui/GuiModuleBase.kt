...
abstract class GuiModuleBase(val module: BoatModule, val boat: IControllable, val playerInventory: InventoryPlayer, val container: Container): GuiContainer(container) {
    ...
    private val BACKGROUND_TEXTURE = ResourceLocation(MoarBoats.ModID, "texture/gui/default_background.png")
    ...
    abstract fun drawModuleForeground(mouseX: Int, mouseY: Int)
    abstract fun drawModuleBackground(mouseX: Int, mouseY: Int)
